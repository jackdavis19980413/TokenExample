...
const Claim = ({ isOpen, onCloseFunc, refresh }) => {
    ...
    const onClaim = (e) => {
        ...
        const handleClaim = async () => {
            try {
                ...
                await contract.methods.claimDividends().send({ from: accounts[0], gas: gasLimit });
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 backdrop-filter backdrop-blur-sm">
            <div className="bg-gray-900 rounded-lg shadow-lg p-8 w-96 relative">
                <button className="absolute top-3 right-3 text-gray-600" onClick={(e) => onCloseFunc(false)}>
                ...
                <h2 className="text-gray-200 text-2xl font-bold mb-6">Claim</h2>
                <div className="mb-6 text-gray-200 ">
                    Are you really want to claim?
                </div>
                <button
